          ...
          <Card className="text-center py-12">
            ...
            <div className="mt-10 pt-10 border-t border-slate-100 flex justify-center gap-6">
              <div className="text-center">
                <div className="text-lg font-black text-slate-900 tracking-tighter">{user?.employeeId || 'N/A'}</div>
                <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest mt-1">Employee ID</div>
              </div>
            </div>
          </Card>
